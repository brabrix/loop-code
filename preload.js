...
contextBridge.exposeInMainWorld('api', {
  ...
  sessionSetCli: (projectPath, sessionId, cli) =>
    ipcRenderer.invoke('session:setCli', { projectPath, sessionId, cli }),
  ...
  todosSubscribe: (projectPath, sessionId) =>
    ipcRenderer.invoke('todos:subscribe', { projectPath, sessionId }),
  ...
  updateRemoteAuth: (projectPath, authType, keyPath, secret) =>
    ipcRenderer.invoke('remotes:updateAuth', { projectPath, authType, keyPath, secret }),
